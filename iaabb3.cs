namespace AoC
{
   ...
   public struct iaabb3
   {
      ...
      {
         return MaxInclusive.z - MinInclusive.z + 1;
      }

      //----------------------------------------------------------------------------------------------         
      public int GetBottom()
      {
         return MinInclusive.z; 
      }
      ...
      public iaabb2 GetXYSlice()
      {
         return iaabb2.ThatContains(MinInclusive.xy, MaxInclusive.xy); 
      }
